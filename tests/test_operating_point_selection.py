...
def test_operating_point_uses_critical_constraint_and_lead_time() -> None:
    candidates = [
        ...
        },
        {
            ...
            "detected_before_critical_rate": 0.8,
            "event_f1": 0.9,
    ...
    result = select_threshold_candidate(
        ...
        minimum_before_critical_rate=0.8,
    ...
    candidates = [
        {
            "event_recall": 0.8,
            "critical_region_recall": 0.8,
            "detected_before_critical_rate": 0.7,
            "event_f1": 0.8,
        ...
        },
        {
            ...
            "detected_before_critical_rate": 0.6,
            "event_f1": 0.7,
...
def test_operating_point_uses_before_critical_constraint() -> None:
    candidates = [
        {
            "event_recall": 1.0,
            "critical_region_recall": 1.0,
            "detected_before_critical_rate": 0.5,
            "event_f1": 0.99,
            "false_alarms_per_day": 0.1,
            "median_lead_time_to_critical_minutes": 5.0,
            "median_detection_delay_minutes": 2.0,
            "point_f1": 0.9,
            "true_events": 10,
        },
        {
            ...
            "event_f1": 0.8,
            "false_alarms_per_day": 0.2,
            "median_lead_time_to_critical_minutes": 15.0,
            "median_detection_delay_minutes": 5.0,
            "point_f1": 0.7,
            "true_events": 10,
        },
    ]
